        ...
        <section>
          <div className={`${pageWidth} pt-12 sm:pt-16 pb-20 sm:pb-28`}>
            <div className="max-w-xl">
              ...
              <h1 className={`mt-6 ${type.h1}`}>Write to us.</h1>
              <p className={`mt-6 ${type.body}`}>
                Questions about Alignment OS, the assessment, or your account can be sent here.
              </p>
              <p className={`mt-8 ${type.body}`}>
                <a href={`mailto:${siteContactEmail}`} className="underline underline-offset-4 hover:text-alignment-accent">
                  {siteContactEmail}
                </a>
              </p>
            </div>
