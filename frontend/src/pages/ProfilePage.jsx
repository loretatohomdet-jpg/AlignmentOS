    ...
    <div className="max-w-xl mx-auto px-6 sm:px-8 py-12 sm:py-16">
      ...
      <div className="mt-10 flex flex-col sm:flex-row gap-8">
        <div className="shrink-0 flex flex-col items-center">
          ...
          <p className="mt-2 text-xs text-alignment-accent/90">Preview</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex-1 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              value={user.email}
              disabled
              className="w-full rounded-xl border border-alignment-accent/10 bg-alignment-accent/[0.04] px-4 py-3 text-alignment-accent/90 cursor-not-allowed"
            />
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span className="text-xs text-alignment-accent/85">JPEG, PNG, WebP, or GIF · max ~200KB</span>
            </div>
