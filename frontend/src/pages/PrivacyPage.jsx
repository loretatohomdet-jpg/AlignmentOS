    ...
    <div className={type.page}>
      ...
      <main className="flex-1 max-w-3xl mx-auto px-6 sm:px-8 py-12 sm:py-16">
        ...
        <div className="mt-10 space-y-6 text-alignment-accent leading-relaxed">
          <section>
            <h2 className={`${type.h3} mt-8`}>1. Information we collect</h2>
          ...
          <section>
            <h2 className={`${type.h3} mt-8`}>2. How we use it</h2>
            <p className="mt-2 text-alignment-accent/70">
          ...
          <section>
            <h2 className={`${type.h3} mt-8`}>3. Data retention & security</h2>
            <p className="mt-2 text-alignment-accent/70">
          ...
          <section>
            <h2 className={`${type.h3} mt-8`}>4. Contact</h2>
            <p className="mt-2 text-alignment-accent/70">
        ...
        <p className="mt-12">
          <Link to="/" className="text-sm text-alignment-accent/70 hover:text-alignment-accent underline underline-offset-4">
            ← Back to home
          </Link>
        </p>
      </main>
