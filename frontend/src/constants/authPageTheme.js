...
export const authPrimaryButtonMarketingClass = `w-full inline-flex items-center justify-center rounded-full bg-alignment-primary text-white text-[15px] font-sans font-medium py-3.5 min-h-12 transition-colors duration-200 hover:bg-alignment-primary/90 disabled:opacity-50 disabled:cursor-not-allowed ${authFocusRingClass}`;

export const authPrimaryButtonCompactClass =
  'w-full rounded-full bg-alignment-primary text-white py-3.5 min-h-12 font-sans text-[15px] font-medium hover:bg-alignment-primary/90 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200';
