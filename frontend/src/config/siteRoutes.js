...
export const routeMap = {
  ...
  Shop: { path: '/shop', visibility: visibility.public, note: 'Tools: Clarity, Planner, Reset' },
  Planner: { path: '/planner', visibility: visibility.public, note: 'Life of Purpose Planner' },
  AlignmentClarity: { path: '/shop/alignment-clarity', visibility: visibility.public, note: 'Digital tool $27' },
