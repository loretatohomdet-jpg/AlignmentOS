...
export const type = {
  ...
  h1: 'font-display font-medium text-[2.15rem] sm:text-[2.75rem] md:text-[3.15rem] leading-[1.18] tracking-tight text-alignment-accent',
  h1Hero:
    'font-display font-medium text-[2.25rem] sm:text-[3.15rem] md:text-[3.45rem] leading-[1.18] tracking-tight text-balance',
